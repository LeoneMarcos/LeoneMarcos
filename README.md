...
A responsive medication inventory application for stock control, expiration tracking, searching, and inventory status monitoring.
...
A browser-based 21 card game with local multiplayer, an optional automated opponent, responsive UI, automated tests, and continuous integration.
